                            ...
                            {dataSources.map(ds => (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-gray-50 ${
                                        ds.id === currentConnection ? 'bg-oxblood/5 text-oxblood-deep' : 'text-gray-700'
                                    }`}
                                >
                                    <Database size={14} className={ds.id === currentConnection ? 'text-oxblood' : 'text-gray-400'} />
            ...
            <div className="flex-1 max-w-md">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-1.5 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-oxblood focus:border-transparent"
                    />
                </div>
            </div>
